...
public final class PendingOrderDecoder
{
    ...
    private final PendingOrderDecoder parentMessage = this;
    ...
    public PendingOrderDecoder wrap(
    ...
    public PendingOrderDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public PendingOrderDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[PendingOrder](sbeTemplateId=");
    ...
    public PendingOrderDecoder sbeSkip()
    {
        sbeRewind();
