...
public final class MessageHeaderDecoder
{
    ...
    public static int sequencerNumberEncodingOffset()
    {
        return 8;
    }

    public static int sequencerNumberEncodingLength()
    {
        return 8;
    }

    public static int sequencerNumberSinceVersion()
    {
        return 0;
    }

    public static long sequencerNumberNullValue()
    {
        return 0xffffffffffffffffL;
    }

    public static long sequencerNumberMinValue()
    {
        return 0x0L;
    }

    public static long sequencerNumberMaxValue()
    {
        return 0xfffffffffffffffeL;
    }

    public long sequencerNumber()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append(version());
        builder.append('|');
        builder.append("sequencerNumber=");
        builder.append(sequencerNumber());
        builder.append(')');
